# Rwik - IIT Gn
# Code for Stresses in Mohr Circle
...
class Stress_MohrCircle():
    def __init__(self, σxx,σyy,σxy,σzz = 0,σyz = 0,σzx = 0):
        ...
        self.isGraph = False
        self.isAngle_stress = False #To be made True if angle of a plane is given
        self.reqAngle_stress_2d = None #the required angle for 2_D mohr (in degrees)
    ...
    def Find_Mohr_Circle(self):
        ...
        # Sorting the values of eigen values in the form of sig1>sig2>sig3
        Stress.sort(reverse=True)
        sigma1=Stress[0]
        sigma2=Stress[1]
        center1_2=round((sigma1+sigma2)/2, 4)
        radius1_2=abs(sigma2-center1_2)
        # Additional params for 3-D stress
        if self.ndims==3:
            sigma3=Stress[2]        
    ...
    # Finding the principal stresses using eigen values ONLY
...
'''Examples'''
'''3-D'''
'''m is an object of class Stress_MohrCircle'''
